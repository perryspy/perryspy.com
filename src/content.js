module.exports = {
  ...
  name: {
    first: "Perry",
    last: "Spyropoulos",
    lastNameBreak: 3, // "Spy" rendered in italic amber, "ropoulos" plain
  },
  ...
  phone:    "843.901.1168",
  linkedin: "YOUR-LINKEDIN-HANDLE", // just the handle
  ...
  experience: [
    {
      ...
      location: "Bethlehem, PA",
      // Use `roles` for multi-project jobs, `bullets` for single-role jobs
      roles: [
        {
  ...
  // ── Theme ──────────────────────────────────────────────────────────────────
  // Maps 1:1 to CSS variables. Swap any value to retheme the whole site.
  theme: {
    bg:             "#0e0f0c",
    bg2:            "#161710",
    bg3:            "#1e1f19",
    ...
    muted:          "#8a8880",
    faint:          "#4a4a44",
    amber:          "#d4943a",   // primary accent color
    "amber-dim":    "#7a5220",
    "amber-bg":     "#1e1608",
    "green-bright": "#6ab570",
  },
